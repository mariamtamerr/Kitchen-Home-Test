  ...
  <div>
    ...
    <div class="relative overflow-hidden">
      <div
        ...
        :key="reviewer.id"
        class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py- mx-auto"
      >
            ...
            <footer class="-mt-10">
              <div class="flex items-center">
                ...
                <div class="ms-4 lg:ms-0">
                  <p class="font-medium text-gray-800 d:text-neutral-200">
                    {{ reviewer.name.first }} {{ reviewer.name.last }}
                  </p>
                  <p class="text-sm text-gray-600 d:text-neutral-400">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Reiciendis deleniti vitae cupiditate asperiores qui,
                    accusamus quidem ullam magnam consequatur dolorem, unde odit
                    aspernatur nam repellendus est tenetur. Fugiat, ab rem.
                  </p>
                </div>
              </div>
            </footer>
