...
<template>
  <div>
    ...
    <div class="relative overflow-hidden">
      <div v-for="reviewer in reviewers" :key="reviewer.id" class="max-w-[85rem]  px-4 py-12 sm:px-6 lg:px-8 lg:py- mx-auto">
        <div class="lg:col-span-4 border-b-2 pb-10 ">
          <!-- Blockquote -->
          <blockquote>
            ...
            <footer class="-mt-10 ">
              <div class="flex items-center">
                <div class="shrink-0">
                  <img
                    class="size-12 lg:size-16 lg:mr-5 rounded-full"
                    :src="reviewer.picture.large"
                    alt="Avatar"
                  />
                </div>
                <div class="ms-4 lg:ms-0">
                  ...
                  <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis deleniti vitae cupiditate asperiores qui, accusamus quidem ullam magnam consequatur dolorem, unde odit aspernatur nam repellendus est tenetur. Fugiat, ab rem.
                  </p>
                </div>
              </div>
            </footer>
